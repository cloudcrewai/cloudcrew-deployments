...
Highly available three-tier web application in us-east-2 across 2 Availability Zones. Features ALB with HTTPS, ECS Fargate services, RDS PostgreSQL Multi-AZ with KMS encryption, ElastiCache Redis, S3 for assets, CloudWatch for logs and alarms, and Secrets Manager for credentials.
...
![Region](https://img.shields.io/badge/Region-us-east-2-orange)

## Architecture

📐 [View Architecture Diagram](https://github.com/cloudcrewai/cloudcrew-deployments/blob/cloudcrew-5cb66185/docs/architecture.png)
...
| Session ID | `5cb66185-303a-45d4-8012-ea5557996c7e` |
...
Shield scan: **✅ PASSED**
- Critical: 0 | High: 2 | Medium: 34 | Low: 9
...
| [Public Subnet AZ-A](docs/runbooks/RUNBOOK-OPS-003-public-subnet-az-a.md) | Operational Runbook |
| [Public Subnet AZ-B](docs/runbooks/RUNBOOK-OPS-004-public-subnet-az-b.md) | Operational Runbook |
| [Private Subnet AZ-A](docs/runbooks/RUNBOOK-OPS-005-private-subnet-az-a.md) | Operational Runbook |
| [Private Subnet AZ-B](docs/runbooks/RUNBOOK-OPS-006-private-subnet-az-b.md) | Operational Runbook |

---
*Generated by [CloudCrew AI](https://cloudcrewai.com) — Session `5cb66185-303a-45d4-8012-ea5557996c7e`*