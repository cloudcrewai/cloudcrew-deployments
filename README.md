...
A production-grade serverless API in a single AZ, featuring API Gateway, Lambda functions, DynamoDB, Cognito for authentication, EventBridge for async processing, SQS with a DLQ, Secrets Manager for keys, and KMS for encryption.
...
📐 [View Architecture Diagram](https://github.com/cloudcrewai/cloudcrew-deployments/blob/cloudcrew-9cd073da/docs/architecture.png)
...
| Estimated Monthly Cost | $29.12 |
| Session ID | `9cd073da-4771-4bb1-9fc5-6dde53f02418` |
...
| [DynamoDB Table](docs/runbooks/RUNBOOK-OPS-003-dynamodb-table.md) | Operational Runbook |

---
*Generated by [CloudCrew AI](https://cloudcrewai.com) — Session `9cd073da-4771-4bb1-9fc5-6dde53f02418`*