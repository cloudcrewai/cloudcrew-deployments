...
📐 [View Architecture Diagram](https://github.com/cloudcrewai/cloudcrew-deployments/blob/cloudcrew-39f6e530/docs/architecture.png)
...
| Session ID | `39f6e530-de85-4662-a15c-1a80344ec795` |
...
Shield scan: **✅ PASSED**
- Critical: 0 | High: 5 | Medium: 7 | Low: 8
...
| [Cost Optimisation Considerations](docs/adr/ADR-004-cost-optimisation-considerations.md) | Architecture Decision Record |
...
---
*Generated by [CloudCrew AI](https://cloudcrewai.com) — Session `39f6e530-de85-4662-a15c-1a80344ec795`*