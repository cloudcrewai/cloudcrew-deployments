...
Highly available three-tier web application on AWS across 2 Availability Zones, featuring ALB with HTTPS, ECS Fargate, Multi-AZ RDS PostgreSQL and ElastiCache Redis, S3 for assets and logs, Secrets Manager for credentials, and comprehensive CloudWatch monitoring. All data at rest is encrypted with customer-managed KMS keys.
...
📐 [View Architecture Diagram](https://github.com/cloudcrewai/cloudcrew-deployments/blob/cloudcrew-ef2f90eb/docs/architecture.png)

## Overview

| Property | Value |
|---|---|
| Project | `prod-three-tier-web` |
| Environment | `production` |
| Region | `us-east-1` |
| IaC Engine | Terraform + Pulumi |
| Availability Zones | 2 |
| Estimated Monthly Cost | $1,091.93 |
| Session ID | `ef2f90eb-5b27-45b8-866c-9372753ac7cf` |
...
| ElastiCache Encryption Key | `kms` |  |
| ElastiCache Redis Primary | `elasticache` |  |
| ElastiCache Redis Replica | `elasticache` |  |
| S3 Application Assets | `s3` |  |
| S3 ALB Logs Encryption Key | `kms` |  |
| S3 ALB Access Logs | `s3` |  |
| Secrets Manager Encryption Key | `kms` |  |
| Database Credentials | `secrets manager` |  |
| CloudWatch Logs Encryption Key | `kms` |  |
| ECS Log Group | `cloudwatch` |  |
| Application Dashboard | `cloudwatch` |  |
| ECS CPU Utilization Alarm | `cloudwatch` |  |
| ECS Memory Utilization Alarm | `cloudwatch` |  |
...
Shield scan: **✅ PASSED**
- Critical: 0 | High: 5 | Medium: 34 | Low: 13
...
| [NAT Gateway](docs/runbooks/RUNBOOK-OPS-002-nat-gateway.md) | Operational Runbook |
| [ECS Fargate](docs/runbooks/RUNBOOK-OPS-003-ecs-fargate.md) | Operational Runbook |
| [RDS PostgreSQL Instance](docs/runbooks/RUNBOOK-OPS-004-rds-postgresql-instance.md) | Operational Runbook |
| [ElastiCache Redis Cluster](docs/runbooks/RUNBOOK-OPS-005-elasticache-redis-cluster.md) | Operational Runbook |

---
*Generated by [CloudCrew AI](https://cloudcrewai.com) — Session `ef2f90eb-5b27-45b8-866c-9372753ac7cf`*