...
📐 [View Architecture Diagram](https://github.com/cloudcrewai/cloudcrew-deployments/blob/cloudcrew-3e6d1200/docs/architecture.png)
...
| Session ID | `3e6d1200-f80d-4d9e-af4f-6327fd6f9fb1` |
...
Shield scan: **✅ PASSED**
- Critical: 0 | High: 0 | Medium: 11 | Low: 3
...
| [Customer Managed KMS Key](docs/runbooks/RUNBOOK-OPS-002-customer-managed-kms-key.md) | Operational Runbook |

---
*Generated by [CloudCrew AI](https://cloudcrewai.com) — Session `3e6d1200-f80d-4d9e-af4f-6327fd6f9fb1`*